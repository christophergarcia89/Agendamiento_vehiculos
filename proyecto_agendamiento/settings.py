"""
Django settings for proyecto_agendamiento project.
...
SECRET_KEY = 'django-insecure-*1v6la9yw&3krwr+^12l84*&cn-k@*lngutmx7%tsxjvuu5m!g'
...
WSGI_APPLICATION = 'proyecto_agendamiento.wsgi.application'
